...
icols=['points']
jcols=['variety']
X = pd.DataFrame(df.drop(df.columns[[0,1,2,3,4,5,6,7,9]], axis=1))
...
converted_data=pd.factorize(obj_df['variety'])[0]
df_notnans['variety'] = converted_data
...
print("Shape of df_nans",df_nans)
